    ...
    },
    {
      ...
      "body": {
        "description": [
          ...
          {
            "type": "option",
            "value": "Interferência Extradimensional",
            "description": "Interferência Extradimensional. As criaturas afetadas não podem se mover ou viajar usando teletransporte ou por meios extradimensionais ou interplanares."
          },
          {
            "type": "option",
            "value": "Luz do Dia",
    ...
    },
    {
      ...
      "body": {
        "description": [
          ...
          {
            "type": "default",
            "description": "O nível da água se mantem elevado até a magia acabar ou você escolher um efeito diferente. Se esse efeito produzir uma onda, a onda se repete no início do seu próximo turno enquanto o efeito de inundação durar."
          },
          {
            "type": "option",
            "value": "Dividir Água",
    ...
    },
    {
      ...
      "body": {
        "description": [
          {
            "type": "default",
            "description": "Uma barreira cintilante se estende de você até 3 metros de raio [10-foot radius], e se move com você, permanecendo centrada em você e restringindo criaturas diferentes de mortos-vivos e constructos. A barreira mantem-se pela duração."
          },
          {
            "type": "default",
      ...
      "body": {
        "description": [
          ...
          },
          {
            "type": "option",
            "value": "Escadas.",
            "description": "Escadas. Teias preenchem todas as escadas na área protegida dotopo ao solo, como a magia teia. Esses fios voltam a crescer em 10minutos se forem queimados ou partidos enquanto proteger fortaleza durar."
          },
          {
            "type": "option",
    ...
    },
    {
      ...
      "body": {
        "description": [
          ...
          {
            "type": "default",
            "description": "A criatura reencarnada lembra-se da sua vida e experiências anteriores. Ela mantem as capacidades que a sua forma original tinha, exceto por trocar sua raça original pela nova e mudar suas características raciais adequadamente."
          }
        ]
      },
      "font": {
    ...
    },
    {
      ...
      "body": {
        "description": [
          ...
          {
            "type": "default",
            "description": "O espaço extradimensional pode ser alcançado escalando a corda até o topo. O espaço pode abrigar até oito criaturas Médias ou menores. A corda pode ser puxada para dentro do buraco, fazendo-a desaparecer para os observadores do lado de fora do espaço."
          },
          {
            "type": "default",
            "description": "Ataques e magias não podem ultrapassar a entrada, entrando ou saindo do espaço extradimensional, mas quem está dentro pode ver o lado de fora, como se estivesse olhando por uma janela de 0,9 metro [3 feet] por 1,5 metro [5 feet], centrada na corda."
          },
          {
            "type": "default",
